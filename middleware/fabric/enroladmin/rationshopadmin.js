...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities["ca.ration_shops.example.com"];
        ...
        const identity = X509WalletMixin.createIdentity("RationshopsMSP", enrollment.certificate, enrollment.key.toBytes());
