...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities["ca.citizens.example.com"];
        ...
        const identity = X509WalletMixin.createIdentity("CitizensMSP", enrollment.certificate, enrollment.key.toBytes());
