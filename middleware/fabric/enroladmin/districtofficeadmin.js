...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities["ca.district_office.example.com"];
        ...
        const identity = X509WalletMixin.createIdentity("DistrictOfficeMSP", enrollment.certificate, enrollment.key.toBytes());
