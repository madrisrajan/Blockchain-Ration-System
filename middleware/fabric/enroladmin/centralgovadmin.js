...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities["ca.central_gov.example.com"];
        ...
        const identity = X509WalletMixin.createIdentity("CentralGovernmentMSP", enrollment.certificate, enrollment.key.toBytes());
