...
async function main() {
    try {
        ...
        const caInfo = ccp.certificateAuthorities["ca.state_gov.example.com"];
        ...
        const identity = X509WalletMixin.createIdentity("StateGovernmentMSP", enrollment.certificate, enrollment.key.toBytes());
